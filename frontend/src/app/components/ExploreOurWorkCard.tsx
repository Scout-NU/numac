...
const ExploreOurWorkCard: React.FC<ExploreOurWorkCardProps> = ({
  name,
  description,
  href = '#',
}) => {
  return (
    <div className="overflow-hidden rounded-md border-l-4 border-[#1f7a5a] bg-[#cfc4b2] shadow-md">
      <div className="p-4">
        ...
        <Link href={href} className="text-sm font-medium text-[#1f7a5a]">
          Read More →
        </Link>
      </div>
    </div>
