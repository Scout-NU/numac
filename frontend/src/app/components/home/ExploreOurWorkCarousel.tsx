  ...
  return (
    <>
      <div className="flex items-center gap-4 md:gap-6">
        <button
          onClick={prev}
          className="hidden h-12 w-12 shrink-0 items-center justify-center rounded-full bg-green-primary shadow-md transition-all active:scale-90 active:brightness-75 md:flex"
        >
